        ...
        <div style={{backgroundColor: '#efefef', paddingTop: '20px', paddingLeft: '20px'}}>
            <WrapperQuantityProduct style={{backgroundColor: '#fff', paddingLeft: '10px', width: '510px'}}>
                ...
                <div style={{paddingTop: '25px'}}>
                    <button style={{backgroundColor: 'rgb(255, 57, 69)', borderRadius: '5px', width: '500px', height: '40px', borderColor: 'rgb(255, 57, 69)', offset: '0px'}}><span style={{fontSize: '20px', color: '#fff', fontWeight: '50px'}}>Mua ngay</span></button>
                </div>
                <div style={{paddingTop:'10px', paddingBottom: '10px'}}>
                    <button style={{backgroundColor: '#fff', borderRadius: '5px', width: '500px', height: '40px', borderColor: 'rgb(26, 148, 255)'}}><span style={{fontSize: '20px', color: 'rgb(26, 148, 255)'}}>Thêm vào giỏ</span></button>
                </div>
