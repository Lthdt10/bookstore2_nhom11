            ...
            <div style={{backgroundColor: '#efefef', paddingTop: '20px'}}>
                <div style={{backgroundColor: '#fff'}}>
                    ...
                    <div style={{paddingLeft:'33px', paddingTop: '18px', paddingBottom: '15px'}}>
                        <button style={{backgroundColor: 'rgb(255, 57, 69)', borderColor: 'rgb(255, 57, 69)', width: '200px', height: '40px', borderRadius: '5px'}}><span style={{color: '#fff', fontSize: '20px'}}>Thanh toán</span></button>
                    </div>
                </div>
            </div>
        </Col>
