  ...
  return (
    <Row style={{backgroundColor: '#fff', height: '170px'}}>
      ...
      <Col span={5}>
        ...
        <div style={{paddingTop: '10px'}}>
          <Image src={imageInstagramIcon} alt="image FooterFaceBookIcon" preview={false} style={{width: '35px'}}></Image>
          <Image src={imageFaceBookIconFooter} alt="image FooterFaceBookIcon" preview={false} style={{width: '45px', paddingLeft: '10px'}}></Image>
