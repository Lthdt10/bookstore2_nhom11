        ...
        <div style={{paddingTop: '20px', width: '500px'}}>
            <div style={{border: 'solid', borderColor: 'rgb(120, 120, 120)', borderTop: 'none', borderBottom:'none', borderLeft: 'none', borderRightWidth: 'thin', height: '350px'}}>
                ...
                <div style={{paddingTop: '151px', paddingLeft: '150px'}}>
                    <button style={{backgroundColor: 'rgb(10, 104, 255)', borderColor: 'rgb(10, 104, 255)', width: '150px', height: '35px', borderRadius: '5px'}}><span style={{color: '#fff'}}>Lưu thay đổi</span></button>
                </div>
            </div>
        </div>
        <div style={{paddingLeft: '40px', paddingTop: '15px'}}>
            <div style={{border: 'solid', borderColor: 'rgb(120, 120, 120)', borderTop: 'none', borderLeft: 'none', borderRight: 'none', borderBottomWidth: 'thin', height: '210px'}}>
                ...
                <div style={{paddingTop: '15px'}}>
                    ...
                    <span style={{paddingTop: '100px'}}>
                        <button style={{color: 'rgb(26, 148, 255)', backgroundColor: '#fff', borderRadius: '5px', borderColor: 'rgb(26, 148, 255)', marginLeft: '150px', width: '150px', height: '35px'}}>Cập nhật</button>
                    </span>
                </div>
                ...
                <div style={{paddingTop: '30px'}}>
                    ...
                    <button style={{color: 'rgb(26, 148, 255)', backgroundColor: '#fff', borderRadius: '5px', borderColor: 'rgb(26, 148, 255)', marginLeft: '219px', width: '150px', height: '35px'}}>Cập nhật</button>
                </div>
            ...
            <div style={{paddingTop: '30px'}}>
                ...
                <div style={{paddingTop: '10px'}}>
                    ...
                    <button style={{color: 'rgb(26, 148, 255)', backgroundColor: '#fff', borderRadius: '5px', borderColor: 'rgb(26, 148, 255)', marginLeft: '147px', width: '150px', height: '35px'}}>Cập nhật</button>
                </div>
            </div>
        </div>
    </div>
